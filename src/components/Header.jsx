    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <h1 className='text-3x1 sm:text-6xl font-semibold sm:leading-16 text-gray-700'>
                ...
                <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>This is your space to think out loud, to share what matter, and to write without filters.
